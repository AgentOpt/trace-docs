---
title: OptoPrime
description: Trace's flagship optimizer using full computation graphs
---

# OptoPrime

OptoPrime is Trace's proposed optimization algorithm that leverages the entire computation graph for efficient optimization.
