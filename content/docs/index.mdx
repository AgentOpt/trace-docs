---
title: Documentation
description: Complete guide to building self-optimizing AI systems with Trace
---

# Trace Documentation

Welcome to the Trace documentation! Trace is a PyTorch-like library for training AI agents end-to-end using general feedback.
...
Trace is a new AutoDiff-like tool for training AI systems with:
...
### 📚 Getting Started
Start here if you're new to Trace. Learn installation, basic concepts, and configuration.
...
- [GitHub](https://github.com/AgentOpt/Trace) - Source code and issues
