---
title: Core Concepts
description: Understanding the fundamental concepts of Trace
---

# Core Concepts

Learn the fundamental concepts that power Trace's optimization framework.

## Overview

Trace brings AutoDiff-like optimization to AI systems. Instead of backpropagating numerical gradients through neural networks, Trace backpropagates **feedback** through **computation graphs** of AI agent execution.
...
<Cards>
  <Card 
    ...
    description="How Trace captures and represents AI system execution"
  />
  <Card 
...
Think of Trace as **PyTorch for AI agents**:
...
1. **Start**: [Computation Graph](/docs/core-concepts/computation-graph) - Understand how Trace tracks execution
