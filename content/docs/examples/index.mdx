---
title: Examples
description: Real-world examples of building AI systems with Trace2
---
...
Check the main [Trace2 repository](https://github.com/AgentOpt/OpenTrace) for full implementations.
...
3. Submit a PR to the [documentation repository](https://github.com/AgentOpt/OpenTrace)
...
- Check [GitHub Issues](https://github.com/AgentOpt/OpenTrace/issues) for questions
- Browse the [examples directory](https://github.com/AgentOpt/OpenTrace/tree/main/examples) in the repo
